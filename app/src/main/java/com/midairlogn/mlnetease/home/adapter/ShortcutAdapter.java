package com.midairlogn.mlnetease.home.adapter;
...
public class ShortcutAdapter extends RecyclerView.Adapter<ShortcutAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvMeta.setText(holder.itemView.getContext().getString(R.string.shortcut_meta_format, display_shortcut_type, shortcut.id));
